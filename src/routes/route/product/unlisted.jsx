...
class unlisted extends Component {
  constructor(props) {
    super(props)
    this.state = {
      data: [],
  ...
  getData = async() => {
    ...
    await productStore.getUnlistedProduct(query).then(async (res) => {
      var array = []
  ...
  render() {
    return (
      ...
      {this.state.loader === true ? <Loader /> : ''}
        <Links link={dataComponent.link_product_unlisted} />
        <div className='row p-0 m-0'>
          <div className='pagination col-12 p-0 m-0'>
            <div className="fillter col-12 p-0 m-0">
              <div className="row p-0 m-0">
                <ComponentProduct totalProduct={this.state.totalProduct} data={this.state.data} thead={dataComponent.theadProducAll} active="unlisted" columnAction={true} />
