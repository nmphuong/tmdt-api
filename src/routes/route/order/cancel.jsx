...
class cancel extends Component {
  ...
  getData() {
    ...
    orderStore.getCancelOrder(query).then(async (res) => {
      var array = []
  ...
  render() {
    return (
      <>
        ...
        <StepOrder dataTable={this.state.dataOrder} columnAction={true} active="cancel" submenu={false} data={dataComponent.data} />
