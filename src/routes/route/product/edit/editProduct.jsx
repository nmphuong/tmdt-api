...
class editProduct extends React.Component {
  ...
  getData = async () => {
    ...
    await productStore.getDetailProduct(window.location.href.substring(window.location.href.lastIndexOf('/') + 1)).then(async (res) => {
      ...
      var arrayClassifyTwo = []
      for (let index = 0; index < res.data.classify.length; index++) {
        if (res.data.classify[index].classify_key === res.data.classify[0].classify_key) {
          arrayClassifyOne.push(res.data.classify[index].classify_value)
        } else {
          arrayClassifyTwo.push(res.data.classify[index].classify_key)
        }
      }
      var arrayShipping = []
      var arrayFees = []
      for (let index = 0; index < res.data.product_shipping.length; index++) {
        arrayShipping.push((res.data.product_shipping[index].product_fees.ship_channel_id).toString())
        arrayFees.push((res.data.product_shipping[index].product_fees.fees).toString())
      }
      await this.setState({
        data: res.data,
        name: res.data.name,
        description: res.data.description,
        branch: res.data.metaProduct.branch,
        material: res.data.metaProduct.material,
        origin: res.data.metaProduct.origin,
        price: res.data.price,
        warehouse: res.data.warehouse,
        sku: res.data.sku,
        numberClassifyOne: arrayClassifyOne.length,
        numberClassifyTwo: arrayClassifyTwo.length,
        keyClassifyOne: (arrayClassifyOne.length !== 0) ? [res.data.classify[0].classify_key] : [null],
        keyClassifyTwo: (arrayClassifyTwo.length !== 0) ? [res.data.classify[arrayClassifyOne.length].classify_key] : [null],
        valueClassifyOne_1: (arrayClassifyOne.length >= 1 && res.data.classify[0] !== null && res.data.classify[0] !== undefined) ? res.data.classify[0].classify_value : null,
        valueClassifyOne_2: (arrayClassifyOne.length >= 2 && res.data.classify[1] !== null && res.data.classify[1] !== undefined) ? res.data.classify[1].classify_value : null,
        valueClassifyOne_3: (arrayClassifyOne.length >= 3 && res.data.classify[2] !== null && res.data.classify[2] !== undefined) ? res.data.classify[2].classify_value : null,
        valueClassifyOne_4: (arrayClassifyOne.length >= 4 && res.data.classify[3] !== null && res.data.classify[3] !== undefined) ? res.data.classify[3].classify_value : null,
        valueClassifyOne_5: (arrayClassifyOne.length >= 5 && res.data.classify[4] !== null && res.data.classify[4] !== undefined) ? res.data.classify[4].classify_value : null,
        valueClassifyOne_6: (arrayClassifyOne.length >= 6 && res.data.classify[5] !== null && res.data.classify[5] !== undefined) ? res.data.classify[5].classify_value : null,
        valueClassifyOne_7: (arrayClassifyOne.length >= 7 && res.data.classify[6] !== null && res.data.classify[6] !== undefined) ? res.data.classify[6].classify_value : null,
        valueClassifyOne_8: (arrayClassifyOne.length >= 8 && res.data.classify[7] !== null && res.data.classify[7] !== undefined) ? res.data.classify[7].classify_value : null,
        valueClassifyOne_9: (arrayClassifyOne.length >= 9 && res.data.classify[8] !== null && res.data.classify[8] !== undefined) ? res.data.classify[8].classify_value : null,
        valueClassifyOne_10: (arrayClassifyOne.length >= 10 && res.data.classify[9] !== null && res.data.classify[9] !== undefined) ? res.data.classify[9].classify_value : null,
        valueClassifyOne_11: (arrayClassifyOne.length >= 11 && res.data.classify[10] !== null && res.data.classify[10] !== undefined) ? res.data.classify[10].classify_value : null,
        valueClassifyOne_12: (arrayClassifyOne.length >= 12 && res.data.classify[11] !== null && res.data.classify[11] !== undefined) ? res.data.classify[11].classify_value : null,
        valueClassifyOne_13: (arrayClassifyOne.length >= 13 && res.data.classify[12] !== null && res.data.classify[12] !== undefined) ? res.data.classify[12].classify_value : null,
        valueClassifyOne_14: (arrayClassifyOne.length >= 14 && res.data.classify[13] !== null && res.data.classify[13] !== undefined) ? res.data.classify[13].classify_value : null,
        valueClassifyOne_15: (arrayClassifyOne.length >= 15 && res.data.classify[14] !== null && res.data.classify[14] !== undefined) ? res.data.classify[14].classify_value : null,
        valueClassifyOne_16: (arrayClassifyOne.length >= 16 && res.data.classify[15] !== null && res.data.classify[15] !== undefined) ? res.data.classify[15].classify_value : null,
        valueClassifyOne_17: (arrayClassifyOne.length >= 17 && res.data.classify[16] !== null && res.data.classify[16] !== undefined) ? res.data.classify[16].classify_value : null,
        valueClassifyOne_18: (arrayClassifyOne.length >= 18 && res.data.classify[17] !== null && res.data.classify[17] !== undefined) ? res.data.classify[17].classify_value : null,
        valueClassifyOne_19: (arrayClassifyOne.length >= 19 && res.data.classify[18] !== null && res.data.classify[18] !== undefined) ? res.data.classify[18].classify_value : null,
        valueClassifyOne_20: (arrayClassifyOne.length >= 20 && res.data.classify[19] !== null && res.data.classify[19] !== undefined) ? res.data.classify[19].classify_value : null,
        // 
        valueClassifyTwo_1: (res.data.classify[arrayClassifyOne.length + 0] !== null && res.data.classify[arrayClassifyOne.length + 0] !== undefined) ? res.data.classify[arrayClassifyOne.length + 0].classify_value : null,
        valueClassifyTwo_2: (res.data.classify[arrayClassifyOne.length + 1] !== null && res.data.classify[arrayClassifyOne.length + 1] !== undefined) ? res.data.classify[arrayClassifyOne.length + 1].classify_value : null,
        valueClassifyTwo_3: (res.data.classify[arrayClassifyOne.length + 2] !== null && res.data.classify[arrayClassifyOne.length + 2] !== undefined) ? res.data.classify[arrayClassifyOne.length + 2].classify_value : null,
        valueClassifyTwo_4: (res.data.classify[arrayClassifyOne.length + 3] !== null && res.data.classify[arrayClassifyOne.length + 3] !== undefined) ? res.data.classify[arrayClassifyOne.length + 3].classify_value : null,
        valueClassifyTwo_5: (res.data.classify[arrayClassifyOne.length + 4] !== null && res.data.classify[arrayClassifyOne.length + 4] !== undefined) ? res.data.classify[arrayClassifyOne.length + 4].classify_value : null,
        valueClassifyTwo_6: (res.data.classify[arrayClassifyOne.length + 5] !== null && res.data.classify[arrayClassifyOne.length + 5] !== undefined) ? res.data.classify[arrayClassifyOne.length + 5].classify_value : null,
        valueClassifyTwo_7: (res.data.classify[arrayClassifyOne.length + 6] !== null && res.data.classify[arrayClassifyOne.length + 6] !== undefined) ? res.data.classify[arrayClassifyOne.length + 6].classify_value : null,
        valueClassifyTwo_8: (res.data.classify[arrayClassifyOne.length + 7] !== null && res.data.classify[arrayClassifyOne.length + 7] !== undefined) ? res.data.classify[arrayClassifyOne.length + 7].classify_value : null,
        valueClassifyTwo_9: (res.data.classify[arrayClassifyOne.length + 8] !== null && res.data.classify[arrayClassifyOne.length + 8] !== undefined) ? res.data.classify[arrayClassifyOne.length + 8].classify_value : null,
        valueClassifyTwo_10: (res.data.classify[arrayClassifyOne.length + 9] !== null && res.data.classify[arrayClassifyOne.length + 9] !== undefined) ? res.data.classify[arrayClassifyOne.length + 9].classify_value : null,
        valueClassifyTwo_11: (res.data.classify[arrayClassifyOne.length + 10] !== null && res.data.classify[arrayClassifyOne.length + 10] !== undefined) ? res.data.classify[arrayClassifyOne.length + 10].classify_value : null,
        valueClassifyTwo_12: (res.data.classify[arrayClassifyOne.length + 11] !== null && res.data.classify[arrayClassifyOne.length + 11] !== undefined) ? res.data.classify[arrayClassifyOne.length + 11].classify_value : null,
        valueClassifyTwo_13: (res.data.classify[arrayClassifyOne.length + 12] !== null && res.data.classify[arrayClassifyOne.length + 12] !== undefined) ? res.data.classify[arrayClassifyOne.length + 12].classify_value : null,
        valueClassifyTwo_14: (res.data.classify[arrayClassifyOne.length + 13] !== null && res.data.classify[arrayClassifyOne.length + 13] !== undefined) ? res.data.classify[arrayClassifyOne.length + 13].classify_value : null,
        valueClassifyTwo_15: (res.data.classify[arrayClassifyOne.length + 14] !== null && res.data.classify[arrayClassifyOne.length + 14] !== undefined) ? res.data.classify[arrayClassifyOne.length + 14].classify_value : null,
        valueClassifyTwo_16: (res.data.classify[arrayClassifyOne.length + 15] !== null && res.data.classify[arrayClassifyOne.length + 15] !== undefined) ? res.data.classify[arrayClassifyOne.length + 15].classify_value : null,
        valueClassifyTwo_17: (res.data.classify[arrayClassifyOne.length + 16] !== null && res.data.classify[arrayClassifyOne.length + 16] !== undefined) ? res.data.classify[arrayClassifyOne.length + 16].classify_value : null,
        valueClassifyTwo_18: (res.data.classify[arrayClassifyOne.length + 17] !== null && res.data.classify[arrayClassifyOne.length + 17] !== undefined) ? res.data.classify[arrayClassifyOne.length + 17].classify_value : null,
        valueClassifyTwo_19: (res.data.classify[arrayClassifyOne.length + 18] !== null && res.data.classify[arrayClassifyOne.length + 18] !== undefined) ? res.data.classify[arrayClassifyOne.length + 18].classify_value : null,
        valueClassifyTwo_20: (res.data.classify[arrayClassifyOne.length + 19] !== null && res.data.classify[arrayClassifyOne.length + 19] !== undefined) ? res.data.classify[arrayClassifyOne.length + 19].classify_value : null,
        // 
        priceClassify_1: (arrayClassifyOne.length >= 1 && res.data.classify[0] !== null && res.data.classify[0] !== undefined) ? res.data.classify[0].classify_price : null,
        priceClassify_2: (arrayClassifyOne.length >= 2 && res.data.classify[1] !== null && res.data.classify[1] !== undefined) ? res.data.classify[1].classify_price : null,
        priceClassify_3: (arrayClassifyOne.length >= 3 && res.data.classify[2] !== null && res.data.classify[2] !== undefined) ? res.data.classify[2].classify_price : null,
        priceClassify_4: (arrayClassifyOne.length >= 4 && res.data.classify[3] !== null && res.data.classify[3] !== undefined) ? res.data.classify[3].classify_price : null,
        priceClassify_5: (arrayClassifyOne.length >= 5 && res.data.classify[4] !== null && res.data.classify[4] !== undefined) ? res.data.classify[4].classify_price : null,
        priceClassify_6: (arrayClassifyOne.length >= 6 && res.data.classify[5] !== null && res.data.classify[5] !== undefined) ? res.data.classify[5].classify_price : null,
        priceClassify_7: (arrayClassifyOne.length >= 7 && res.data.classify[6] !== null && res.data.classify[6] !== undefined) ? res.data.classify[6].classify_price : null,
        priceClassify_8: (arrayClassifyOne.length >= 8 && res.data.classify[7] !== null && res.data.classify[7] !== undefined) ? res.data.classify[7].classify_price : null,
        priceClassify_9: (arrayClassifyOne.length >= 9 && res.data.classify[8] !== null && res.data.classify[8] !== undefined) ? res.data.classify[8].classify_price : null,
        priceClassify_10: (arrayClassifyOne.length >= 10 && res.data.classify[9] !== null && res.data.classify[9] !== undefined) ? res.data.classify[9].classify_price : null,
        priceClassify_11: (arrayClassifyOne.length >= 11 && res.data.classify[10] !== null && res.data.classify[10] !== undefined) ? res.data.classify[10].classify_price : null,
        priceClassify_12: (arrayClassifyOne.length >= 12 && res.data.classify[11] !== null && res.data.classify[11] !== undefined) ? res.data.classify[11].classify_price : null,
        priceClassify_13: (arrayClassifyOne.length >= 13 && res.data.classify[12] !== null && res.data.classify[12] !== undefined) ? res.data.classify[12].classify_price : null,
        priceClassify_14: (arrayClassifyOne.length >= 14 && res.data.classify[13] !== null && res.data.classify[13] !== undefined) ? res.data.classify[13].classify_price : null,
        priceClassify_15: (arrayClassifyOne.length >= 15 && res.data.classify[14] !== null && res.data.classify[14] !== undefined) ? res.data.classify[14].classify_price : null,
        priceClassify_16: (arrayClassifyOne.length >= 16 && res.data.classify[15] !== null && res.data.classify[15] !== undefined) ? res.data.classify[15].classify_price : null,
        priceClassify_17: (arrayClassifyOne.length >= 17 && res.data.classify[16] !== null && res.data.classify[16] !== undefined) ? res.data.classify[16].classify_price : null,
        priceClassify_18: (arrayClassifyOne.length >= 18 && res.data.classify[17] !== null && res.data.classify[17] !== undefined) ? res.data.classify[17].classify_price : null,
        priceClassify_19: (arrayClassifyOne.length >= 19 && res.data.classify[18] !== null && res.data.classify[18] !== undefined) ? res.data.classify[18].classify_price : null,
        priceClassify_20: (arrayClassifyOne.length >= 20 && res.data.classify[19] !== null && res.data.classify[19] !== undefined) ? res.data.classify[19].classify_price : null,
        // 
        warehouseClassify_1: (arrayClassifyOne.length >= 1 && res.data.classify[0] !== null && res.data.classify[0] !== undefined) ? res.data.classify[0].classify_warehouse : null,
        warehouseClassify_2: (arrayClassifyOne.length >= 2 && res.data.classify[1] !== null && res.data.classify[1] !== undefined) ? res.data.classify[1].classify_warehouse : null,
        warehouseClassify_3: (arrayClassifyOne.length >= 3 && res.data.classify[2] !== null && res.data.classify[2] !== undefined) ? res.data.classify[2].classify_warehouse : null,
        warehouseClassify_4: (arrayClassifyOne.length >= 4 && res.data.classify[3] !== null && res.data.classify[3] !== undefined) ? res.data.classify[3].classify_warehouse : null,
        warehouseClassify_5: (arrayClassifyOne.length >= 5 && res.data.classify[4] !== null && res.data.classify[4] !== undefined) ? res.data.classify[4].classify_warehouse : null,
        warehouseClassify_6: (arrayClassifyOne.length >= 6 && res.data.classify[5] !== null && res.data.classify[5] !== undefined) ? res.data.classify[5].classify_warehouse : null,
        warehouseClassify_7: (arrayClassifyOne.length >= 7 && res.data.classify[6] !== null && res.data.classify[6] !== undefined) ? res.data.classify[6].classify_warehouse : null,
        warehouseClassify_8: (arrayClassifyOne.length >= 8 && res.data.classify[7] !== null && res.data.classify[7] !== undefined) ? res.data.classify[7].classify_warehouse : null,
        warehouseClassify_9: (arrayClassifyOne.length >= 9 && res.data.classify[8] !== null && res.data.classify[8] !== undefined) ? res.data.classify[8].classify_warehouse : null,
        warehouseClassify_10: (arrayClassifyOne.length >= 10 && res.data.classify[9] !== null && res.data.classify[9] !== undefined) ? res.data.classify[9].classify_warehouse : null,
        warehouseClassify_11: (arrayClassifyOne.length >= 11 && res.data.classify[10] !== null && res.data.classify[10] !== undefined) ? res.data.classify[10].classify_warehouse : null,
        warehouseClassify_12: (arrayClassifyOne.length >= 12 && res.data.classify[11] !== null && res.data.classify[11] !== undefined) ? res.data.classify[11].classify_warehouse : null,
        warehouseClassify_13: (arrayClassifyOne.length >= 13 && res.data.classify[12] !== null && res.data.classify[12] !== undefined) ? res.data.classify[12].classify_warehouse : null,
        warehouseClassify_14: (arrayClassifyOne.length >= 14 && res.data.classify[13] !== null && res.data.classify[13] !== undefined) ? res.data.classify[13].classify_warehouse : null,
        warehouseClassify_15: (arrayClassifyOne.length >= 15 && res.data.classify[14] !== null && res.data.classify[14] !== undefined) ? res.data.classify[14].classify_warehouse : null,
        warehouseClassify_16: (arrayClassifyOne.length >= 16 && res.data.classify[15] !== null && res.data.classify[15] !== undefined) ? res.data.classify[15].classify_warehouse : null,
        warehouseClassify_17: (arrayClassifyOne.length >= 17 && res.data.classify[16] !== null && res.data.classify[16] !== undefined) ? res.data.classify[16].classify_warehouse : null,
        warehouseClassify_18: (arrayClassifyOne.length >= 18 && res.data.classify[17] !== null && res.data.classify[17] !== undefined) ? res.data.classify[17].classify_warehouse : null,
        warehouseClassify_19: (arrayClassifyOne.length >= 19 && res.data.classify[18] !== null && res.data.classify[18] !== undefined) ? res.data.classify[18].classify_warehouse : null,
        warehouseClassify_20: (arrayClassifyOne.length >= 20 && res.data.classify[19] !== null && res.data.classify[19] !== undefined) ? res.data.classify[19].classify_warehouse : null,
        // 
        skuClassify_1: (arrayClassifyOne.length >= 1 && res.data.classify[0] !== null && res.data.classify[0] !== undefined) ? res.data.classify[0].classify_sku : null,
        skuClassify_2: (arrayClassifyOne.length >= 2 && res.data.classify[1] !== null && res.data.classify[1] !== undefined) ? res.data.classify[1].classify_sku : null,
        skuClassify_3: (arrayClassifyOne.length >= 3 && res.data.classify[2] !== null && res.data.classify[2] !== undefined) ? res.data.classify[2].classify_sku : null,
        skuClassify_4: (arrayClassifyOne.length >= 4 && res.data.classify[3] !== null && res.data.classify[3] !== undefined) ? res.data.classify[3].classify_sku : null,
        skuClassify_5: (arrayClassifyOne.length >= 5 && res.data.classify[4] !== null && res.data.classify[4] !== undefined) ? res.data.classify[4].classify_sku : null,
        skuClassify_6: (arrayClassifyOne.length >= 6 && res.data.classify[5] !== null && res.data.classify[5] !== undefined) ? res.data.classify[5].classify_sku : null,
        skuClassify_7: (arrayClassifyOne.length >= 7 && res.data.classify[6] !== null && res.data.classify[6] !== undefined) ? res.data.classify[6].classify_sku : null,
        skuClassify_8: (arrayClassifyOne.length >= 8 && res.data.classify[7] !== null && res.data.classify[7] !== undefined) ? res.data.classify[7].classify_sku : null,
        skuClassify_9: (arrayClassifyOne.length >= 9 && res.data.classify[8] !== null && res.data.classify[8] !== undefined) ? res.data.classify[8].classify_sku : null,
        skuClassify_10: (arrayClassifyOne.length >= 10 && res.data.classify[9] !== null && res.data.classify[9] !== undefined) ? res.data.classify[9].classify_sku : null,
        skuClassify_11: (arrayClassifyOne.length >= 11 && res.data.classify[10] !== null && res.data.classify[10] !== undefined) ? res.data.classify[10].classify_sku : null,
        skuClassify_12: (arrayClassifyOne.length >= 12 && res.data.classify[11] !== null && res.data.classify[11] !== undefined) ? res.data.classify[11].classify_sku : null,
        skuClassify_13: (arrayClassifyOne.length >= 13 && res.data.classify[12] !== null && res.data.classify[12] !== undefined) ? res.data.classify[12].classify_sku : null,
        skuClassify_14: (arrayClassifyOne.length >= 14 && res.data.classify[13] !== null && res.data.classify[13] !== undefined) ? res.data.classify[13].classify_sku : null,
        skuClassify_15: (arrayClassifyOne.length >= 15 && res.data.classify[14] !== null && res.data.classify[14] !== undefined) ? res.data.classify[14].classify_sku : null,
        skuClassify_16: (arrayClassifyOne.length >= 16 && res.data.classify[15] !== null && res.data.classify[15] !== undefined) ? res.data.classify[15].classify_sku : null,
        skuClassify_17: (arrayClassifyOne.length >= 17 && res.data.classify[16] !== null && res.data.classify[16] !== undefined) ? res.data.classify[16].classify_sku : null,
        skuClassify_18: (arrayClassifyOne.length >= 18 && res.data.classify[17] !== null && res.data.classify[17] !== undefined) ? res.data.classify[17].classify_sku : null,
        skuClassify_19: (arrayClassifyOne.length >= 19 && res.data.classify[18] !== null && res.data.classify[18] !== undefined) ? res.data.classify[18].classify_sku : null,
        skuClassify_20: (arrayClassifyOne.length >= 20 && res.data.classify[19] !== null && res.data.classify[19] !== undefined) ? res.data.classify[19].classify_sku : null,
        // 
        bmdFrom_1: (res.data.buy_more_discount[0] !== undefined && res.data.buy_more_discount[0] !== null) ? res.data.buy_more_discount[0].discount_from : null,
        bmdFrom_2: (res.data.buy_more_discount[1] !== undefined && res.data.buy_more_discount[1] !== null) ? res.data.buy_more_discount[1].discount_from : null,
        bmdFrom_3: (res.data.buy_more_discount[2] !== undefined && res.data.buy_more_discount[2] !== null) ? res.data.buy_more_discount[2].discount_from : null,
        bmdFrom_4: (res.data.buy_more_discount[3] !== undefined && res.data.buy_more_discount[3] !== null) ? res.data.buy_more_discount[3].discount_from : null,
        bmdFrom_5: (res.data.buy_more_discount[4] !== undefined && res.data.buy_more_discount[4] !== null) ? res.data.buy_more_discount[4].discount_from : null,
        // 
        bmdTo_1: (res.data.buy_more_discount[0] !== undefined && res.data.buy_more_discount[0] !== null) ? res.data.buy_more_discount[0].discount_to : null,
        bmdTo_2: (res.data.buy_more_discount[1] !== undefined && res.data.buy_more_discount[1] !== null) ? res.data.buy_more_discount[1].discount_to : null,
        bmdTo_3: (res.data.buy_more_discount[2] !== undefined && res.data.buy_more_discount[2] !== null) ? res.data.buy_more_discount[2].discount_to : null,
        bmdTo_4: (res.data.buy_more_discount[3] !== undefined && res.data.buy_more_discount[3] !== null) ? res.data.buy_more_discount[3].discount_to : null,
        bmdTo_5: (res.data.buy_more_discount[4] !== undefined && res.data.buy_more_discount[4] !== null) ? res.data.buy_more_discount[4].discount_to : null,
        // 
        bmdPrice_1: (res.data.buy_more_discount[0] !== undefined && res.data.buy_more_discount[0] !== null) ? res.data.buy_more_discount[0].discount_price : null,
        bmdPrice_2: (res.data.buy_more_discount[1] !== undefined && res.data.buy_more_discount[1] !== null) ? res.data.buy_more_discount[1].discount_price : null,
        bmdPrice_3: (res.data.buy_more_discount[2] !== undefined && res.data.buy_more_discount[2] !== null) ? res.data.buy_more_discount[2].discount_price : null,
        bmdPrice_4: (res.data.buy_more_discount[3] !== undefined && res.data.buy_more_discount[3] !== null) ? res.data.buy_more_discount[3].discount_price : null,
        bmdPrice_5: (res.data.buy_more_discount[4] !== undefined && res.data.buy_more_discount[4] !== null) ? res.data.buy_more_discount[4].discount_price : null,
        // 
        numberBmd: res.data.buy_more_discount.length,
        // 
        showClassify: (res.data.classify.length !== 0) ? true : false,
        showClassify_1: (arrayClassifyOne.length !== 0) ? true : false,
        showClassify_2: (arrayClassifyTwo.length !== 0) ? true : false,
        // 
        srcImageAVT: res.data.thumb,
        dataImageAVT: 'no change',
        // 
        srcImage_1: (res.data.image[0] !== undefined && res.data.image[0] !== null) ? res.data.image[0] : null,
        srcImage_2: (res.data.image[1] !== undefined && res.data.image[1] !== null) ? res.data.image[1] : null,
        srcImage_3: (res.data.image[2] !== undefined && res.data.image[2] !== null) ? res.data.image[2] : null,
        srcImage_4: (res.data.image[3] !== undefined && res.data.image[3] !== null) ? res.data.image[3] : null,
        srcImage_5: (res.data.image[4] !== undefined && res.data.image[4] !== null) ? res.data.image[4] : null,
        srcImage_6: (res.data.image[5] !== undefined && res.data.image[5] !== null) ? res.data.image[5] : null,
        srcImage_7: (res.data.image[6] !== undefined && res.data.image[6] !== null) ? res.data.image[6] : null,
        srcImage_8: (res.data.image[7] !== undefined && res.data.image[7] !== null) ? res.data.image[7] : null,
        // 
        dataImage_1: 'no change',
        dataImage_2: 'no change',
        dataImage_3: 'no change',
        ...
        dataImage_8: 'no change',
        //
        srcImageClassify_1: (res.data.classify[0] !== undefined && res.data.classify[0] !== null && arrayClassifyOne.length >= 1) ? res.data.classify[0].classify_image : null,
        srcImageClassify_2: (res.data.classify[1] !== undefined && res.data.classify[1] !== null && arrayClassifyOne.length >= 2) ? res.data.classify[1].classify_image : null,
        srcImageClassify_3: (res.data.classify[2] !== undefined && res.data.classify[2] !== null && arrayClassifyOne.length >= 3) ? res.data.classify[2].classify_image : null,
        srcImageClassify_4: (res.data.classify[3] !== undefined && res.data.classify[3] !== null && arrayClassifyOne.length >= 4) ? res.data.classify[3].classify_image : null,
        srcImageClassify_5: (res.data.classify[4] !== undefined && res.data.classify[4] !== null && arrayClassifyOne.length >= 5) ? res.data.classify[4].classify_image : null,
        srcImageClassify_6: (res.data.classify[5] !== undefined && res.data.classify[5] !== null && arrayClassifyOne.length >= 6) ? res.data.classify[5].classify_image : null,
        srcImageClassify_7: (res.data.classify[6] !== undefined && res.data.classify[6] !== null && arrayClassifyOne.length >= 7) ? res.data.classify[6].classify_image : null,
        srcImageClassify_8: (res.data.classify[7] !== undefined && res.data.classify[7] !== null && arrayClassifyOne.length >= 8) ? res.data.classify[7].classify_image : null,
        srcImageClassify_9: (res.data.classify[8] !== undefined && res.data.classify[8] !== null && arrayClassifyOne.length >= 9) ? res.data.classify[8].classify_image : null,
        srcImageClassify_10: (res.data.classify[9] !== undefined && res.data.classify[9] !== null && arrayClassifyOne.length >= 10) ?res.data.classify[9].classify_image : null,
        srcImageClassify_11: (res.data.classify[10] !== undefined && res.data.classify[10] !== null && arrayClassifyOne.length >= 11) ?res.data.classify[10].classify_image : null,
        srcImageClassify_12: (res.data.classify[11] !== undefined && res.data.classify[11] !== null && arrayClassifyOne.length >= 12) ?res.data.classify[11].classify_image : null,
        srcImageClassify_13: (res.data.classify[12] !== undefined && res.data.classify[12] !== null && arrayClassifyOne.length >= 13) ?res.data.classify[12].classify_image : null,
        srcImageClassify_14: (res.data.classify[13] !== undefined && res.data.classify[13] !== null && arrayClassifyOne.length >= 14) ?res.data.classify[13].classify_image : null,
        srcImageClassify_15: (res.data.classify[14] !== undefined && res.data.classify[14] !== null && arrayClassifyOne.length >= 15) ?res.data.classify[14].classify_image : null,
        srcImageClassify_16: (res.data.classify[15] !== undefined && res.data.classify[15] !== null && arrayClassifyOne.length >= 16) ?res.data.classify[15].classify_image : null,
        srcImageClassify_17: (res.data.classify[16] !== undefined && res.data.classify[16] !== null && arrayClassifyOne.length >= 17) ?res.data.classify[16].classify_image : null,
        srcImageClassify_18: (res.data.classify[17] !== undefined && res.data.classify[17] !== null && arrayClassifyOne.length >= 18) ?res.data.classify[17].classify_image : null,
        srcImageClassify_19: (res.data.classify[18] !== undefined && res.data.classify[18] !== null && arrayClassifyOne.length >= 19) ?res.data.classify[18].classify_image : null,
        srcImageClassify_20: (res.data.classify[19] !== undefined && res.data.classify[19] !== null && arrayClassifyOne.length >= 20) ?res.data.classify[19].classify_image : null,
        // 
        dataImageClassify_1: 'no change',
        dataImageClassify_2: 'no change',
        dataImageClassify_3: 'no change',
        ...
        dataImageClassify_20: 'no change',
        // 
        weight: res.data.product_shipping[0].weight,
        height: res.data.product_shipping[0].height,
        width: res.data.product_shipping[0].width,
        length: res.data.product_shipping[0].length,
        shippingChannels: arrayShipping,
        feesShip: arrayFees,
        book: (res.data.metaProduct.book === 0) ? 0 : 1 ,
        status: res.data.metaProduct.status,
        // 
        loader: false
      })
      if (this.state.numberClassifyOne === 0) {
        await this.setState({
          numberClassifyOne: 1
        })
      }
      if (this.state.numberClassifyTwo === 0) {
        await this.setState({
          numberClassifyTwo: 1
        })
      }
      ...
      // this.setState({
      //   valueClassifyOne: arrayClassifyOne
      // })
      // await this.setValueDefault()
    }).catch(async (e) => {
      await this.setState({
        loader: false
      })
  ...
  render() {
    if(this.state.data !== null && this.state.dataShipping !== null) {
      var feesShippings = []
      for (let shipping = 0; shipping < this.state.dataShipping.length; shipping++) {
        var haveShipping = false
        for (let feesShip = 0; feesShip < this.state.data.product_shipping.length; feesShip++) {
          if (this.state.dataShipping[shipping].id === this.state.data.product_shipping[feesShip].product_fees.ship_channel_id) {
            feesShippings.push(
              <div key={shipping} className={"row p-0 m-0" + ((shipping % 2 === 0) ? ' event-div-shipping-fees' : ' odd-div-shipping-fees')}>
                <div className="basic-user col-lg-7">
                  <p className="">
                    {this.state.dataShipping[shipping].name}&nbsp;(Tối đa: {this.state.dataShipping[shipping].maximumWeight}g)
                  </p>
                </div>
                  ...
                  <p>
                    {
                      (this.state.weight === '' || this.state.weight === null)
                        ? ''
                        : ((parseInt(this.state.weight) > parseInt(this.state.dataShipping[shipping].maximumWeight))
                          ? "Quá cân nặng"
                          : ((this.state.dataShipping[shipping].recipe * this.state.weight)).toLocaleString('en-US', {style : 'currency', currency : 'VND'})
                        )
                    }
                  </p>
                </div>
                    ...
                    (this.state.weight === '' || this.state.weight === null)
                      ...
                      : ((parseInt(this.state.weight) > parseInt(this.state.dataShipping[shipping].maximumWeight))
                        ...
                        <div className="custom-control d-flex custom-switch custom-switch-lg px-0 col-lg-1 col-md-6 justify-content-end col-md-2">
                          <input disabled type="checkbox" className="custom-control-input" id={this.state.dataShipping[shipping].id} />
                          <label className="disabled custom-control-label" htmlFor={this.state.dataShipping[shipping].id}></label>
                        </div>
                        : 
                        <div className="custom-control d-flex custom-switch custom-switch-lg px-0 col-lg-1 col-md-6 justify-content-end col-md-2">
                          <input defaultChecked="true" value={(this.state.dataShipping[shipping].recipe * this.state.weight).toFixed(0).toLocaleString('en-US', {style : 'currency', currency : 'VND'})} onChange={this.onChangeShipping} type="checkbox" className="custom-control-input" id={this.state.dataShipping[shipping].id} />
                          <label className="custom-control-label" htmlFor={this.state.dataShipping[shipping].id}></label>
                        </div>
                      )
                  }
              </div>
            ...
            haveShipping = true
          } else if (feesShip === (this.state.data.product_shipping.length - 1) && haveShipping === false) {
            feesShippings.push(
              <div key={shipping} className={"row p-0 m-0" + ((shipping % 2 === 0) ? ' event-div-shipping-fees' : ' odd-div-shipping-fees')}>
                <div className="basic-user col-lg-7">
                  <p className="">
                ...
                </div>
                  {
                    (this.state.weight === '' || this.state.weight === null)
                      ...
                      : ((parseInt(this.state.weight) > parseInt(this.state.dataShipping[shipping].maximumWeight))
                        ...
                        : 
                        <div className="custom-control d-flex custom-switch custom-switch-lg px-0 col-lg-1 col-md-6 justify-content-end col-md-2">
                          <input value={(this.state.dataShipping[shipping].recipe * this.state.weight).toFixed(0).toLocaleString('en-US', {style : 'currency', currency : 'VND'})} onChange={this.onChangeShipping} type="checkbox" className="custom-control-input" id={this.state.dataShipping[shipping].id} />
                          <label className="custom-control-label" htmlFor={this.state.dataShipping[shipping].id}></label>
                        </div>
                      )
                  }
    ...
    return (
      ...
      {
      (this.state.data !== null && this.state.dataShipping !== null) 
      ?
        <div>
                        ...
                        <div className="px-4">
                          ...
                          <div className="row py-2">
                            ...
                            <div key="1" className="col-md-9 div-input-name-product position-relative">
                              ...
                              <span className="length-character-input-name-product-new position-absolute">{this.state.data.name.length}/120</span>
                              {
                          ...
                          <div className="row py-2">
                            ...
                            <div className="col-md-9 div-input-name-product position-relative">
                              ...
                              <div className="w-100 text-right">
                                <span>{this.state.data.description.length}/3000</span>
                              </div>
                              {
                                (this.state.data.description.length < 10)
                          ...
                          <div className="row py-2">
                            ...
                            <div className="col-md-9 text-danger">
                              {
                                (this.state.data.cate_id[2] !== undefined && this.state.data.cate_id[2] !== null)
                                ? <span>{this.state.data.cate_id[2].name}</span>
                                : ''
                              }
                              {
                                (this.state.data.cate_id[1] !== undefined && this.state.data.cate_id[1] !== null)
                                ? <span>&nbsp;<FontFa.FaAngleRight />&nbsp;{this.state.data.cate_id[1].name}</span>
                                : ''
                              }
                              {
                                (this.state.data.cate_id[0] !== undefined && this.state.data.cate_id[0] !== null)
                                ? <span>&nbsp;<FontFa.FaAngleRight />&nbsp;{this.state.data.cate_id[0].name}</span>
                                : ''
                              }
                            </div>
                          </div>
                    ...
                    <div className="py-3">
                      <div className="  p-2">
                        <div className="p-0 py-3 row justify-content-end ">
                          ...
                          <button onClick={this.updateProduct} id="cancel-save-and-hide-product" className="btn btn-light mr-2" style={{"border": '1px solid rgb(225, 225, 225)'}}>Lưu thay đổi</button>
                        </div>
                      </div>
                    </div>
                  </div>
