...
class shipping extends Component {
  ...
  getData() {
    ...
    orderStore.getShippingOrder(query).then(async (res) => {
      var array = []
  ...
  render() {
    return (
      <>
        ...
        <StepOrder dataTable={this.state.dataOrder} columnAction={true} active="shipping" submenu={false} data={dataComponent.data} />
