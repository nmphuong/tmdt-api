      ...
      <>
        <div className="row py-2">
          ...
          <div className="col-md-9 div-input-name-product position-relative">
            <textarea maxLength="3000" minLength="1" onChange={this.handleChangeDescription} value={this.state.description} className="w-100 form-control textarea-description" placeholder="Nhập vào" name="" id="textarea-description" rows="5"></textarea>
