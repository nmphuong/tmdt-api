...
class complete extends Component {
  ...
  getData() {
    ...
    orderStore.getCompletedOrder(query).then(async (res) => {
      var array = []
  ...
  render() {
    return (
      <>
        ...
        <Links link={dataComponent.link_order_cancel} />
        <StepOrder dataTable={this.state.dataOrder} columnAction={true} active="completed" submenu={false} data={dataComponent.data} />
