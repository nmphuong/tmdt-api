...
class toship extends Component {
  ...
  getData() {var query = {}
    ...
    orderStore.getToShipOrder(query).then(async (res) => {
      var array = []
  ...
  render() {
    return (
      <>
        ...
        <StepOrder dataTable={this.state.dataOrder} columnAction={true} active="toship" submenu={false} data={dataComponent.data} />
