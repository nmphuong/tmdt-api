...
class soldout extends Component {
  ...
  getData = async() => {
    ...
    await productStore.getSoldoutProduct(query).then(async (res) => {
      var array = []
  ...
  render() {
    return (
      ...
      {this.state.loader === true ? <Loader /> : ''}
        <Links link={dataComponent.link_product_soldout} />
        <div className='row p-0 m-0'>
          <div className='pagination col-12 p-0 m-0'>
            <div className="fillter col-12 p-0 m-0">
              <div className="row p-0 m-0">
                <ComponentProduct totalProduct={this.state.totalProduct} data={this.state.data} thead={dataComponent.theadProducAll} active="soldout" columnAction={true} />
