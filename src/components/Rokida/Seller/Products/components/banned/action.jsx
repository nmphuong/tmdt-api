...
class action extends Component {
  ...
  getData = async() => {
    ...
    await productStore.getAllProductBannedAction(query).then(async (res) => {
      var array = []
      ...
      await res.data.forEach(item => {
        ...
        array.push({
          name: item.name,
          timeUpdate: item.time_update + ' Phút',
          expiredUpdate: item.error_correction_deadline,
  ...
  render() {
    var thead = dataComponent.theadProductBannedAction
    var nav_link = []
